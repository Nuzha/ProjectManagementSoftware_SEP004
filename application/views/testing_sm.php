...
// this where i wanted to assign the drop down value
	    ...
	    <label >Active: </label>
            <?php $sql1 = "SELECT COUNT(u_status)from user_stories where u_status='active'and ProjectId='$p_id'";
	    ...
	    <label >Warning: </label>
            <?php $sql2 = "SELECT COUNT(u_status)from user_stories where u_status='warning'and ProjectId='$p_id'";
