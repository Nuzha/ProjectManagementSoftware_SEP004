...
You can <a href="http://localhost/CodeIgniter/index.php/welcome/users">see the list of users</a>.<br /><br />
<?php
...
<a href="welcome/load_list">My personnal messages(<?php echo $nb_new_pm; ?> unread)</a><br />
 ...
 <div class="modal-footer"><footer class="footer" style="background-color:#c2c2c2"><a href="home">MINDZPARK</a></footer></div> 	
</html>
<?php
}
else
...
?>
<a href="http://localhost/CodeIgniter/index.php/welcome/signups">Sign up</a><br />
   ...
   <?php echo form_open('welcome/verify'); ?>
    ...
    <button type="submit" value="login" class="btn">Sign in</button>
         	...
         	<div class="modal-footer"><footer class="footer" style="background-color:#c2c2c2"><a href="home" class="foot">MINDZPARK</a></footer></div>	
	</body>
